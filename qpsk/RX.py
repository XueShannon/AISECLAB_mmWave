...
class RX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_source_0 = uhd.usrp_source(
            ",".join(("addr = 192.168.10.2", '', "master_clock_rate=120e6")),
            uhd.stream_args(
                cpu_format="fc32",
                args='',
        ...
        self.connect((self.blocks_threshold_ff_0_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.digital_clock_recovery_mm_xx_0, 0), (self.blocks_threshold_ff_0_0, 0))
