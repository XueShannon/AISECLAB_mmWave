...
% Generated on: 29-Mar-2025 16:09:14

%% Generating Downlink waveform
% Downlink configuration
cfgDL = nrDLCarrierConfig;
cfgDL.Label = 'DL-FRC-FR1-16QAM';
...
scscarrier.SubcarrierSpacing = 60;
scscarrier.NSizeGrid = 20;
...
coreset.FrequencyResources = ones([1 3]);
coreset.Duration = 2;
...
searchspace.NumCandidates = [8 1 1 0 0];
...
filename = "HalfBand-BW-28PC"+cfgDL.ChannelBandwidth +"-"+ cfgDL.PDSCH{1}.Modulation +"_waveform.mat";
