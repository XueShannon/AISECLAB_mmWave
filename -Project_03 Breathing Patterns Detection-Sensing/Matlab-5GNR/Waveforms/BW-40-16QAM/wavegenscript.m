...
% Generated on: 09-Mar-2025 22:35:02
...
scscarrier1.NSizeGrid = 51;
scscarrier1.NStartGrid = 0;

% Carrier 2
scscarrier2 = nrSCSCarrierConfig;
scscarrier2.SubcarrierSpacing = 30;
scscarrier2.NSizeGrid = 20;
scscarrier2.NStartGrid = 41;
...
pdcch.AggregationLevel = 2;
pdcch.AllocatedCandidate = 1;
pdcch.CCEOffset = [];
pdcch.SlotAllocation = 2:39;
pdcch.Period = 5;
pdcch.Coding = true;
pdcch.DataBlockSize = 20;
pdcch.DataSource = 'PN9';
pdcch.RNTI = 0;
...
save('vars.mat','cfgDL','waveform','info');
filename = "BW"+cfgDL.ChannelBandwidth +"-"+ cfgDL.PDSCH{1}.Modulation +"_waveform.mat";
