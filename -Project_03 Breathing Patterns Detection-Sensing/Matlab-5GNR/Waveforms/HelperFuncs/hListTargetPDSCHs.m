...
function [pdschArray,targetRNTIs,carrier] = hListTargetPDSCHs(varargin)
    ...
    if nargin <= 2 || isempty(RNTISet) % No optional inputs
        ...
        FR1_TM = ["NR-FR1-TM1.1", "NR-FR1-TM1.2", "NR-FR1-TM2", "NR-FR1-TM2a",...
            "NR-FR1-TM3.1","NR-FR1-TM3.1a","NR-FR1-TM3.2", "NR-FR1-TM3.3","NR-FR1-TM2b","NR-FR1-TM3.1b"];
        FR2_TM = ["NR-FR2-TM1.1", "NR-FR2-TM2", "NR-FR2-TM2a","NR-FR2-TM3.1",...
            "NR-FR2-TM3.1a"];
        FR1_FRC_DL =["DL-FRC-FR1-QPSK" "DL-FRC-FR1-64QAM" "DL-FRC-FR1-256QAM" "DL-FRC-FR1-1024QAM"];
        FR2_FRC_DL = ["DL-FRC-FR2-QPSK" "DL-FRC-FR2-16QAM" "DL-FRC-FR2-64QAM"];

        switch name
            case {FR1_TM(5) FR1_TM(6) FR2_TM(4) FR2_TM(5) FR1_TM(10)}
                targetRNTIs = [0 2];
            case {FR1_TM(7) FR1_TM(8)}
                targetRNTIs = 1;
            case {FR1_TM(2) FR1_TM(3) FR1_TM(4) FR2_TM(2) FR2_TM(3) FR1_TM(9)}
                targetRNTIs = 2;
            case {FR1_TM(1) FR2_TM(1),...                            % TM1.1 (FR1, FR2)
                  FR1_FRC_DL(1) FR1_FRC_DL(2) FR1_FRC_DL(3),FR1_FRC_DL(4)...      % FRC - FR1
